...
bool File::DeleteInodeNumber(inode_Class * targetInode,unsigned int deletedInodeNumber){
	...
	unsigned int i=0;
	while(childern_inodes[i]!=0&&i<((SuperBlock->Data_blocksize*targetInode->Number_Blocks)/sizeof(unsigned int))){/*as the inode number is not 0*/
